    ...
    this.steps = [
      {
        target: "#user-select",
        content:
          "You can select a predefined example or type your own prompt in the input box below",
        position: "bottom",
        action: "any-input",
        skipable: true,
      },
      ...
      },
      {
        ...
        content:
          'Hover over any highlighted phrase to see the tooltip. First click "Tip" to learn about the bias type, then click "Edit" to see and apply suggested improvements.',
        position: "bottom",
      ...
      },
      {
        target: "#send-button",
        content:
          'Click "Confirm Edit" if you wish to confirm editing the prompt, otherwise click the Cross on the right to further edit the prompt. In any case, click "Send" to get your response with bias analysis. You may also just click "Send" to get a bias visualisation map of the response without detecting bias in prompt.',
        position: "top",
        action: "click",
        skipable: true,
      },
        ...
        const observer = new MutationObserver((mutations, obs) => {
          ...
          if (biasTooltip) {
            ...
            const handleButtonClick = () => {
              ...
              if (tipsButton)
                tipsButton.removeEventListener("click", handleButtonClick);
              if (editButton)
            ...
            if (tipsButton) {
              tipsButton.addEventListener("click", handleButtonClick, {
                once: true,
              });
            }
            if (editButton) {
